!(function (e, t) {
  ...
  function b(e, t) {
    return "doi" in e
      ? `${t ? "<br>" : ""} <a href="https://doi.org/${
          e.doi
        }" style="text-decoration:inherit;">DOI: ${e.doi}</a>`
      : "";
  }
  function y(e) {
      ...
      .map(
        (e) =>
          `\n        <p class="author">\n          ${
            ...
            .map((e) =>
              e.url
                ? `<a class="affiliation" href="${e.url}">${e.name}</a>`
                : `<span class="affiliation">${e.name}</span>`,
            )
            .join(", ")}\n        </p>\n      `,
      )
      .join("")}\n    </div>\n    <div>\n      <h3>Published</h3>\n      ${
  ...
  function z(e, t) {
    ...
    if (s && !l) {
      ...
      (r && i) ||
        ((l = e.createElement("d-interstitial")),
  ...
  function T(e, t) {
    ...
    if (
      ...
      t.publishedDate &&
        i(
          `\n    <!--  https://schema.org/Article -->\n    <meta property="description"       itemprop="description"   content="${me(
            t.description,
          )}" />\n    <meta property="article:published" itemprop="datePublished" content="${
            t.publishedISODateOnly
      ...
      n && n[1]
        ...
        : ("journal" in e && (t += `citation_journal_title=${me(e.journal)};`),
          ...
          ("issue" in e || "number" in e) &&
            (t += `citation_number=${me(e.issue || e.number)};`),
          t)
    );
  }
  function R(e) {
    ...
    return (
      ...
      void 0 !== e.publishedDate &&
        (t += `\n    <h3 id="citation">Citation</h3>\n    <p>For attribution in academic contexts, please cite this work as</p>\n    <pre class="citation short">${
          e.concatenatedAuthors
        }, "${e.title}", Distill, ${
          e.publishedYear
        }.</pre>\n    <p>BibTeX citation</p>\n    <pre class="citation long">${d(
          e,
        )}</pre>\n    `),
      t
    );
  ...
  const K = [
    ...
    X = (e) => (e < 10 ? "0" + e : e),
    Z = function (e) {
      return `${K[e.getDay()].substring(0, 3)}, ${X(e.getDate())} ${J[
        e.getMonth()
      ].substring(0, 3)} ${e.getFullYear().toString()} ${e
        .getUTCHours()
        .toString()}:${e.getUTCMinutes().toString()}:${e
        .getUTCSeconds()
        .toString()} Z`;
    },
    Q = function (e) {
                    ...
                    return (
                      (0, i.default)(e, [
                        ...
                        },
                        {
                          ...
                          value: function () {
                            return this.size !== o
                              ? ["sizing", "reset-size" + this.size, "size" + o]
                              : [];
                          },
                        },
                        {
                          ...
                          value: function () {
                            return (
                              this._fontMetrics ||
                                (this._fontMetrics = a.default.getFontMetrics(
                                  this.size,
                                )),
                              this._fontMetrics
                            );
                            ...
                            if (-1 !== t) {
                              ...
                              (a =
                                1 === s.length && "ordgroup" === s[0].type
                                  ? s[0]
                                  : new p.default("ordgroup", s, this.mode)),
                                (o =
                                  1 === l.length && "ordgroup" === l[0].type
                                    ? l[0]
                                    : new p.default("ordgroup", l, this.mode));
                        ...
                        },
                        {
                          ...
                          value: function () {
                            for (
                              ...
                              t.push(new p.default("textord", e[n], "text"));
                            var r = new p.default(
                                "text",
                                { body: t, type: "text" },
                                this.mode,
                          ...
                          value: function () {
                            ...
                            for (var t = void 0, n = void 0; ; ) {
                              ...
                              if (
                                ...
                                if (t)
                                  throw new f.default("Double superscript", r);
                                t = this.handleSupSubscript("superscript");
                              } else if ("_" === r.text) {
                                if (n)
                                  throw new f.default("Double subscript", r);
                          ...
                          value: function () {
                            ...
                            if (c.default.contains(e.sizeFuncs, n)) {
                              ...
                              return new p.default(
                                "sizing",
                                {
                                  size: c.default.indexOf(e.sizeFuncs, n) + 1,
                                  value: b,
                                },
                                this.mode,
                              );
                          ...
                          value: function (e) {
                            ...
                            if (this.nextToken.text === (e ? "[" : "{")) {
                              ...
                              return (
                                ...
                                new r(
                                  new p.default("ordgroup", n, this.mode, t, i),
                                  !1,
                                )
                              );
                            }
                ...
                var r = n(e("./domTree")),
                  ...
                  p = function (e, t, n) {
                    ...
                    if (c) {
                      ...
                      return (
                        (p =
                          "mathit" === c || o.default.contains(s, i)
                            ? h(i)
                            : x[c]),
                        l(i, p.fontName, r).metrics
                          ? u(i, p.fontName, r, t, a.concat([p.fontClass || c]))
                          : d(i, r, t, a, n)
                      );
                    }
                    return d(i, r, t, a, n);
                  ...
                  b = function (e, t, n) {
                    ...
                    if ("individualShift" === t) {
                      ...
                      for (o = 0; o < e.length; o++)
                        "kern" === e[o].type
                          ? (c -= e[o].size)
                          : (c -= e[o].elem.height + e[o].elem.depth);
                      i = c;
                    } else
                      i =
                        "bottom" === t
            ...
            35: [
              function (e, t) {
                ...
                var i = n(e("babel-runtime/core-js/json/stringify")),
                  ...
                  f = function (e) {
                    return (
                      e instanceof c.default.span && "mspace" === e.classes[0]
                    );
                  },
                  m = function (e) {
                  ...
                  y = function (e, t, n) {
                    for (var r = [], i = 0; i < e.length; i++) {
                      var a = e[i],
                        o = C(a, t);
                      o instanceof c.default.documentFragment
                    ...
                    for (var u = 0; u < r.length; u++) {
                      ...
                      if (d) {
                        ...
                        r[u] instanceof c.default.symbolNode &&
                  ...
                  z = {
                    ...
                    supsub: function (e, t) {
                      ...
                      if (e.value.sup)
                        if (e.value.sub) {
                          ...
                          n instanceof c.default.symbolNode &&
                    ...
                    genfrac: function (e, t) {
                      ...
                      if (0 === p) {
                        ...
                        m - c.depth - (x + 0.5 * p) < g &&
                          (m += g - (m - c.depth - (x + 0.5 * p))),
                          x - 0.5 * p - (d.height - v) < g &&
                            (v += g - (x - 0.5 * p - (d.height - v)));
                        var w = -(x - 0.5 * p);
                        b = l.default.makeVList(
                          [
                            { type: "elem", elem: d, shift: v },
                    ...
                    spacing: function (e, t) {
                      return "\\ " === e.value ||
                        ...
                        : (0, s.makeSpan)(
                            [
                              "mspace",
                              l.default.spacingFunctions[e.value].className,
                            ],
                            [],
                            t,
                          );
                    ...
                    op: function (e, t) {
                      ...
                      if (e.value.symbol) {
                        ...
                        p = l.default.makeSymbol(e.value.body, f, "math", t, [
                          "mop",
                          "op-symbol",
                          d ? "large-op" : "small-op",
                        ]);
                        ...
                        for (var g = [], v = 1; v < e.value.body.length; v++)
                          g.push(l.default.mathsym(e.value.body[v], e.mode));
                        p = (0, s.makeSpan)(["mop"], g, t);
                      }
                      var b = 0,
                        x = 0;
                      if (
                        (p instanceof c.default.symbolNode &&
                          ((b =
                            (p.height - p.depth) / 2 -
                      ...
                      if (
                        ("bmod" === e.value.modType
                          ? (t.style.isTight() ||
                            ...
                            n.push(
                              (0, s.makeSpan)(["mspace", "thickspace"], [], t),
                            ))
                          : t.style.size === o.default.DISPLAY.size
                        ...
                        "bmod" === e.value.modType
                          ...
                          : (Array.prototype.push.apply(n, r),
                            n.push(
                              (0, s.makeSpan)(["mspace", "sixmuspace"], [], t),
                            ));
                      }
                      return (
                        e.value.value &&
                ...
                (z.overline = function (e, t) {
                  ...
                  (z.sqrt = function (e, t) {
                    var n = C(e.value.body, t.havingCrampedStyle());
                    n instanceof c.default.documentFragment &&
                      (n = (0, s.makeSpan)([], [n], t));
                  ...
                  (z.rule = function (e, t) {
                    var n = (0, s.makeSpan)(["mord", "rule"], [], t),
                      r = 0;
                    e.value.shift &&
                      (r = d.default.calculateSize(e.value.shift, t));
                  ...
                  (z.enclose = function (e, t) {
                    ...
                    return (
                      ...
                      /cancel/.test(r)
                        ? (0, s.makeSpan)(["mord", "cancel-lap"], [d], t)
                        : (0, s.makeSpan)(["mord"], [d], t)
                    );
                  }),
                  (z.xArrow = function (e, t) {
                    ...
                    e.value.below &&
                      ...
                      (a = C(e.value.below, r, t)).classes.push("x-arrow-pad"));
              ...
              function (e, t) {
                ...
                var r = e("./buildCommon"),
                  ...
                  p = function (e, t) {
                    ...
                    var o = e.value;
                    if (c.default.contains(["\\imath", "\\jmath"], o))
                      return null;
                    u.default[i][o] &&
                ...
                (f.mathord = function (e, t) {
                  ...
                  (f.supsub = function (e, t) {
                    ...
                    if (n) s = r ? "mover" : "munder";
                      ...
                      if (e.value.sup) {
                        var u = e.value.base;
                        s =
                          u && u.value.limits && t.style === l.default.DISPLAY
                            ? "munderover"
                            : "msubsup";
                      } else s = "msub";
                    else s = "msup";
                  ...
                  (f.accent = function (e, t) {
                    ...
                    n = e.value.isStretchy
                      ? d.default.mathMLnode(e.value.label)
                  ...
                  (f.spacing = function (e) {
                    ...
                    return (
                      ...
                      "~" === e.value
                        ...
                        : (t = new o.default.MathNode("mspace")).setAttribute(
                            "width",
                  ...
                  (f.mod = function (e, t) {
                    ...
                    if (
                      (("pod" !== e.value.modType &&
                        "pmod" !== e.value.modType) ||
                        n.push(new o.default.MathNode("mo", [h("(", e.mode)])),
                      "pod" !== e.value.modType &&
                        n.push(
                  ...
                  (f.xArrow = function (e, t) {
                    ...
                    if (e.value.body) {
                      ...
                      e.value.below
                        ? ((i = v(e.value.below, t)),
                          (r = new o.default.MathNode("munderover", [n, i, a])))
                          ...
                          value: function () {
                            ...
                            this.attributes))
                              Object.prototype.hasOwnProperty.call(
                                ...
                                ((e += " " + r + '="'),
                                (e += o.default.escape(this.attributes[r])),
                                (e += '"'));
                          ...
                          value: function () {
                            ...
                            for (var t in this.attributes)
                              Object.prototype.hasOwnProperty.call(
                                ...
                                ((e += " " + t + '="'),
                                (e += a.default.escape(this.attributes[t])),
                                (e += '"'));
                            e += ">";
                            for (var n = 0; n < this.children.length; n++)
                  ...
                  c = function (e, t) {
                    ...
                    if (i.contains(["widehat", "widetilde", "undertilde"], r)) {
                      ...
                      if (d > 5)
                        ...
                        var h = [1, 1, 2, 2, 3, 3][d];
                        "widehat" === r
                          ? ((a = [0, 0.24, 0.3, 0.3, 0.36, 0.36][d]),
                            (l = "widehat" + h))
                          : ((a = [0, 0.26, 0.3, 0.3, 0.34, 0.34][d]),
                            (l = "tilde" + h));
                      }
                    } else {
                      var p = s[r];
              ...
              function (e, t) {
                ...
                var r = n(e("./ParseError")),
                  ...
                  s = function (e, t) {
                    ...
                    if (e.unit in i)
                      n =
                        i[e.unit] / t.fontMetrics().ptPerEm / t.sizeMultiplier;
                      ...
                      if (
                        ...
                        if ("em" !== e.unit)
                          throw new r.default("Invalid unit: '" + e.unit + "'");
        ...
        if ("text" === e[a].type) {
          ...
          for (
            s = o.indexOf(t),
              -1 !== s &&
                ((u = s),
                i.push({ type: "text", data: o.slice(0, u) }),
                (l = !1));
            ;
