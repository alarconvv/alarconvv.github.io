!(function (t) {
  ...
  function t(t, n) {
    (t.title = n.title),
      n.published &&
        (n.published instanceof Date
          ? (t.publishedDate = n.published)
          : n.published.constructor === String &&
            (t.publishedDate = new Date(n.published))),
      n.publishedDate &&
        (n.publishedDate instanceof Date
          ? (t.publishedDate = n.publishedDate)
          : n.publishedDate.constructor === String &&
            (t.publishedDate = new Date(n.publishedDate))),
      (t.description = n.description),
      (t.authors = n.authors.map((t) => new Nr(t))),
      (t.katex = n.katex),
  ...
  function n(t = document) {
    const n = new Set(),
      e = t.querySelectorAll("d-cite");
    for (const t of e) {
      const e = (t.getAttribute("key") || t.getAttribute("bibtex-key"))
        .split(",")
        .map((t) => t.trim());
  ...
  function e(t, n, e, i) {
    if (null == t.author) return "";
    var r = t.author.split(" and ");
    let o = r.map((t) => {
      if (-1 != (t = t.trim()).indexOf(","))
        var e = t.split(",")[0].trim(),
          i = t.split(",")[1];
      else if (-1 != t.indexOf(" "))
        (e = t.split(" ").slice(-1)[0].trim()),
          (i = t.split(" ").slice(0, -1).join(" "));
      else e = t.trim();
      var r = "";
      return (
        null != i &&
          (r =
            (r = i
              ...
              .split(" ")
              .map((t) => t.trim()[0])).join(".") + "."),
        n.replace("${F}", i).replace("${L}", e).replace("${I}", r).trim()
      );
    });
    if (r.length > 1) {
  ...
  function i(t) {
    var n = t.journal || t.booktitle || "";
    if ("volume" in t) {
      var e = t.issue || t.number;
      (e = null != e ? "(" + e + ")" : ""), (n += ", Vol " + t.volume + e);
    }
    return (
      "pages" in t && (n += ", pp. " + t.pages),
      "" != n && (n += ". "),
      "publisher" in t && "." != (n += t.publisher)[n.length - 1] && (n += "."),
      n
    );
  }
  function r(t) {
    if ("url" in t) {
      var n = t.url,
        e = /arxiv\.org\/abs\/([0-9\.]*)/.exec(n);
      if (
        (null != e && (n = `http://arxiv.org/pdf/${e[1]}.pdf`),
        ".pdf" == n.slice(-4))
      )
        var i = "PDF";
      else if (".html" == n.slice(-5)) i = "HTML";
      return ` &ensp;<a href="${n}">[${i || "link"}]</a>`;
    }
    return "";
  }
  function o(t, n) {
    return "doi" in t
      ? `${n ? "<br>" : ""} <a href="https://doi.org/${
          t.doi
        }" style="text-decoration:inherit;">DOI: ${t.doi}</a>`
      : "";
  }
  function a(t) {
    return '<span class="title">' + t.title + "</span> ";
  }
  function s(t) {
    if (t) {
      var n = a(t);
      return (
        ...
        t.author &&
          ((n += e(t, "${L}, ${I}", ", ", " and ")),
          (t.year || t.date) && (n += ", ")),
        t.year || t.date ? (n += (t.year || t.date) + ". ") : (n += ". "),
        (n += i(t)),
        (n += o(t))
      );
    }
  ...
  function l(t) {
    if (t) {
      var n = "";
      (n += "<strong>" + t.title + "</strong>"), (n += r(t)), (n += "<br>");
      var a = e(t, "${I} ${L}", ", ") + ".",
        s = i(t).trim() + " " + t.year + ". " + o(t, !0);
      return (
        (a + s).length < Math.min(40, t.title.length)
          ? (n += a + " " + s)
          : (n += a + "<br>" + s),
        n
      );
  ...
  // Copyright 2018 The Distill Template Authors
  function c(t) {
    for (let n of t.authors) {
      const t = Boolean(n.affiliation),
        e = Boolean(n.affiliations);
      if (t)
        if (e);
        else {
          let t = { name: n.affiliation };
          n.affiliationURL && (t.url = n.affiliationURL),
            (n.affiliations = [t]);
        }
    }
    return t;
  ...
  function d(t) {
    ...
    if (n) {
      if ("json" == n.getAttribute("type").split("/")[1]) {
  ...
  function h(t, n) {
    const e = t.body;
    if (!e.querySelector("d-article")) return;
    let i = t.querySelector("d-byline");
    i || (n.authors && (i = t.createElement("d-byline")));
    let r = t.querySelector("d-title");
    r || ((r = t.createElement("d-title")), e.insertBefore(r, i));
    let o = r.querySelector("h1");
    o ||
      ((o = t.createElement("h1")),
      (o.textContent = n.title),
      r.insertBefore(o, r.firstChild));
    const a = void 0 !== n.password;
    let s = e.querySelector("d-interstitial");
    if (a && !s) {
      const i = "undefined" != typeof window,
        r = i && window.location.hostname.includes("localhost");
      (i && r) ||
        ((s = t.createElement("d-interstitial")),
        (s.password = n.password),
        e.insertBefore(s, e.firstChild));
    } else !a && s && s.parentElement.removeChild(this);
    let l = t.querySelector("d-appendix");
    l || ((l = t.createElement("d-appendix")), t.body.appendChild(l));
    let u = t.querySelector("d-footnote-list");
    u || ((u = t.createElement("d-footnote-list")), l.appendChild(u));
    let c = t.querySelector("d-citation-list");
    c || ((c = t.createElement("d-citation-list")), l.appendChild(c));
  }
  // Copyright 2018 The Distill Template Authors
  function p(t) {
    const n = "distill-prerendered-styles";
    if (!t.getElementById(n)) {
      const e = t.createElement("style");
      (e.id = n), (e.type = "text/css");
      const i = t.createTextNode(Kr);
      e.appendChild(i);
      const r = t.head.querySelector("script");
      t.head.insertBefore(e, r);
    }
  }
  // Copyright 2018 The Distill Template Authors
  function f(t, n) {
    ...
    (e.src = t.url),
      ...
      (e.onerror = function () {
        new Error("Runlevel 0: Polyfills failed to load script " + t.name);
      }),
  ...
  function b(t) {
    return t
      .replace(/[\t\n ]+/g, " ")
      .replace(/{\\["^`.'acu~Hvs]( )?([a-zA-Z])}/g, (t, n, e) => e)
      .replace(/{\\([a-zA-Z])}/g, (t, n) => n);
  }
  function y(t) {
    const n = new Map(),
      e = oo.toJSON(t);
    for (const t of e) {
      for (const [n, e] of Object.entries(t.entryTags))
        t.entryTags[n.toLowerCase()] = b(e);
      (t.entryTags.type = t.entryType), n.set(t.citationKey, t.entryTags);
    }
    return n;
  }
  function v(t) {
    return `@article{${t.slug},\n  author = {${t.bibtexAuthors}},\n  title = {${t.title}},\n  journal = {${t.journal.title}},\n  year = {${t.publishedYear}},\n  note = {${t.url}},\n  doi = {${t.doi}}\n}`;
  }
  // Copyright 2018 The Distill Template Authors
  // Copyright 2018 The Distill Template Authors
  function w(t) {
      ...
      .map(
        (t) =>
          `\n        <p class="author">\n          ${
            ...
            .map((t) =>
              t.url
                ? `<a class="affiliation" href="${t.url}">${t.name}</a>`
                : `<span class="affiliation">${t.name}</span>`,
            )
            .join(", ")}\n        </p>\n      `,
      )
      .join("")}\n    </div>\n    <div>\n      <h3>Published</h3>\n      ${
  ...
  function x(t, n, e = document) {
    if (n.size > 0) {
      t.style.display = "";
      let i = t.querySelector(".references");
      if (i) i.innerHTML = "";
      else {
        const n = e.createElement("style");
        (n.innerHTML = co), t.appendChild(n);
        const r = e.createElement("h3");
        (r.id = "references"),
          (r.textContent = "References"),
          t.appendChild(r),
          (i = e.createElement("ol")),
      ...
      for (const [t, r] of n) {
        ...
        (n.id = t), (n.innerHTML = s(r)), i.appendChild(n);
      }
  ...
  function k(t, n) {
    ...
    for (const t of n) {
      const n = "D-TITLE" == t.parentElement.tagName,
        i = t.getAttribute("no-toc");
      if (n || i) continue;
      const r = t.textContent;
      let o =
        '<li><a href="' + ("#" + t.getAttribute("id")) + '">' + r + "</a></li>";
      "H3" == t.tagName ? (o = "<ul>" + o + "</ul>") : (o += "<br>"), (e += o);
    }
    (e += "</ul></nav>"), (t.innerHTML = e);
  }
  // Copyright 2018 The Distill Template Authors
  function S(t, n) {
  ...
  function _(t, n, e) {
    ...
    for (
      var i = -1, r = 0 | Math.max(0, Math.ceil((n - t) / e)), o = new Array(r);
      ++i < r;
          ...
          : (n = zo.exec(t))
            ...
            : (n = qo.exec(t))
              ...
              : (n = jo.exec(t))
                ...
                : (n = Bo.exec(t))
                  ? G(n[1], n[2] / 100, n[3] / 100, 1)
                  : (n = Yo.exec(t))
                    ? G(n[1], n[2] / 100, n[3] / 100, n[4])
                    : Go.hasOwnProperty(t)
                      ? $(Go[t])
                      : "transparent" === t
                        ? new q(NaN, NaN, NaN, 0)
  ...
  function P(t) {
    return (
      t instanceof O || (t = U(t)),
      t ? new q((t = t.rgb()).r, t.g, t.b, t.opacity) : new q()
    );
  }
  function z(t, n, e, i) {
    return 1 === arguments.length ? P(t) : new q(t, n, e, null == i ? 1 : i);
  }
  function q(t, n, e, i) {
  ...
  function V(t) {
    ...
    if ((t instanceof O || (t = U(t)), !t)) return new K();
    ...
    return (
      s
        ? ((a =
          ...
          (a *= 60))
        : (s = l > 0 && l < 1 ? 0 : a),
      new K(a, s, l, t.opacity)
    );
  }
  function W(t, n, e, i) {
    return 1 === arguments.length ? V(t) : new K(t, n, e, null == i ? 1 : i);
  }
  function K(t, n, e, i) {
  ...
  function Z(t) {
    ...
    if (t instanceof at) return st(t);
    t instanceof q || (t = P(t));
    var n,
      e,
      i = it(t.r),
      r = it(t.g),
      o = it(t.b),
      a = tt((0.2225045 * i + 0.7168786 * r + 0.0606169 * o) / Zo);
    return (
      i === r && r === o
        ? (n = e = a)
        : ((n = tt((0.4360747 * i + 0.3850649 * r + 0.1430804 * o) / Xo)),
          (e = tt((0.0139322 * i + 0.0971045 * r + 0.7141733 * o) / Qo))),
      new J(116 * a - 16, 500 * (n - a), 200 * (a - e), t.opacity)
    );
  }
  function Q(t, n, e, i) {
    return 1 === arguments.length ? Z(t) : new J(t, n, e, null == i ? 1 : i);
  }
  function J(t, n, e, i) {
    (this.l = +t), (this.a = +n), (this.b = +e), (this.opacity = +i);
  }
  function tt(t) {
    return t > ea ? Math.pow(t, 1 / 3) : t / na + Jo;
  }
  function nt(t) {
    return t > ta ? t * t * t : na * (t - Jo);
  }
  function et(t) {
    return (
  ...
  function rt(t) {
    if (t instanceof at) return new at(t.h, t.c, t.l, t.opacity);
    if ((t instanceof J || (t = Z(t)), 0 === t.a && 0 === t.b))
      return new at(NaN, 0 < t.l && t.l < 100 ? 0 : NaN, t.l, t.opacity);
    var n = Math.atan2(t.b, t.a) * Wo;
    return new at(
      n < 0 ? n + 360 : n,
  ...
  function ot(t, n, e, i) {
    return 1 === arguments.length ? rt(t) : new at(t, n, e, null == i ? 1 : i);
  }
  function at(t, n, e, i) {
    (this.h = +t), (this.c = +n), (this.l = +e), (this.opacity = +i);
  }
  function st(t) {
    if (isNaN(t.h)) return new J(t.l, 0, 0, t.opacity);
    var n = t.h * Vo;
  ...
  function lt(t) {
    ...
    var n = t.r / 255,
      e = t.g / 255,
      i = t.b / 255,
      r = (ca * i + la * n - ua * e) / (ca + la - ua),
      o = i - r,
      a = (sa * (e - r) - oa * o) / aa,
      s = Math.sqrt(a * a + o * o) / (sa * r * (1 - r)),
      l = s ? Math.atan2(a, o) * Wo - 120 : NaN;
    return new ct(l < 0 ? l + 360 : l, s, r, t.opacity);
  }
  function ut(t, n, e, i) {
    return 1 === arguments.length ? lt(t) : new ct(t, n, e, null == i ? 1 : i);
  }
  function ct(t, n, e, i) {
    (this.h = +t), (this.s = +n), (this.l = +e), (this.opacity = +i);
  }
  ...
  function ft(t) {
    return 1 == (t = +t)
      ? gt
      : function (n, e) {
          return e - n ? pt(n, e, t) : dt(isNaN(n) ? e : n);
        };
  }
  function gt(t, n) {
    var e = n - t;
  ...
  function Mt(t, n) {
    var e,
      ...
      s = [],
      l = [];
    for (t += "", n += ""; (e = pa.exec(t)) && (i = fa.exec(n)); )
      (r = i.index) > o &&
        ((r = n.slice(o, r)), s[a] ? (s[a] += r) : (s[++a] = r)),
        (e = e[0]) === (i = i[0])
          ? s[a]
            ? (s[a] += i)
            : (s[++a] = i)
          : ((s[++a] = null), l.push({ i: a, x: wt(e, i) })),
        (o = fa.lastIndex);
    return (
      o < n.length && ((r = n.slice(o)), s[a] ? (s[a] += r) : (s[++a] = r)),
      s.length < 2
        ? l[0]
          ? St(l[0].x)
          : kt(n)
        : ((n = l.length),
          function (t) {
            for (var e, i = 0; i < n; ++i) s[(e = l[i]).i] = e.x(t);
            return s.join("");
          })
    );
  }
  ...
  function Dt(t, n, e) {
    var i = t[0],
      ...
      a = n[1];
    return (
      r < i ? ((i = Nt(r, i)), (o = e(a, o))) : ((i = Nt(i, r)), (o = e(o, a))),
      function (t) {
        return o(i(t));
      }
    );
  ...
  function Ot(t, n, e) {
    ...
    for (
      ...
      (r[a] = Nt(t[a], t[a + 1])), (o[a] = e(n[a], n[a + 1]));
    return function (n) {
      var e = No(t, n, 1, i) - 1;
      return o[e](r[e](n));
    };
  ...
  function Ft() {
    function t() {
      var t = Math.min(l.length, u.length);
      return (
        d !== Ct && (d = Lt(l[0], l[t - 1])),
        (o = t > 2 ? Ot : Dt),
        (a = s = null),
    ...
    function n(t) {
      return isNaN((t = +t)) ? r : (a || (a = o(l.map(e), u, c)))(e(d(t)));
    }
    var e,
      i,
      r,
    ...
    return (
      (n.invert = function (t) {
        return d(i((s || (s = o(u, l.map(e), wt)))(t)));
      }),
      (n.domain = function (n) {
        return arguments.length ? ((l = Array.from(n, Et)), t()) : l.slice();
      }),
      (n.range = function (n) {
        return arguments.length ? ((u = Array.from(n)), t()) : u.slice();
      }),
      (n.rangeRound = function (n) {
        return (u = Array.from(n)), (c = _t), t();
      }),
      (n.clamp = function (n) {
        return arguments.length ? ((d = !!n || Ct), t()) : d !== Ct;
      }),
  ...
  function $t(t) {
    return (t = Ut(Math.abs(t))) ? t[1] : NaN;
  }
  function Ht(t, n) {
    return function (e, i) {
      for (
        var r = e.length, o = [], a = 0, s = t[0], l = 0;
        r > 0 &&
        s > 0 &&
  ...
  function zt(t) {
    if (!(n = ma.exec(t))) throw new Error("invalid format: " + t);
    var n;
    return new qt({
      fill: n[1],
      align: n[2],
  ...
  function Vt(t) {
          ...
          if (
            ...
            for (n = -1, r = t.length; ++n < r; )
              if (48 > (o = t.charCodeAt(n)) || o > 57) {
                (p = (46 === o ? a + t.slice(n + 1) : t.slice(n)) + p),
                  (t = t.slice(0, n));
                break;
              }
        }
        m && !f && (t = i(t, 1 / 0));
        var T = l.length + t.length + p.length,
          _ = T < g ? new Array(g - T + 1).join(e) : "";
        switch (
          (m &&
            f &&
            ((t = i(_ + t, _.length ? g - p.length : 1 / 0)), (_ = "")),
          d)
        ) {
          case "<":
            t = l + t + p + _;
          ...
          case "=":
            ...
            break;
          case "^":
            t = _.slice(0, (T = _.length >> 1)) + l + t + p + _.slice(T);
            break;
          default:
            t = _ + l + t + p;
        }
    ...
    function e(t, e) {
      var i = n((((t = zt(t)).type = "f"), t)),
        r = 3 * Math.max(-8, Math.min(8, Math.floor($t(e) / 3))),
        o = Math.pow(10, -r),
        a = ka[8 + r / 3];
      return function (t) {
        return i(o * t) + a;
    ...
    var i =
        void 0 === t.grouping || void 0 === t.thousands
          ? Gt
          : Ht(xa.call(t.grouping, Number), t.thousands + ""),
      r = void 0 === t.currency ? "" : t.currency[0] + "",
      o = void 0 === t.currency ? "" : t.currency[1] + "",
      a = void 0 === t.decimal ? "." : t.decimal + "",
      s = void 0 === t.numerals ? Gt : Pt(xa.call(t.numerals, String)),
  ...
  function Wt(t) {
    return (ba = Vt(t)), (ya = ba.format), (va = ba.formatPrefix), ba;
  }
  function Kt(t) {
  ...
  function Xt(t, n) {
    return Math.max(
      0,
      3 * Math.max(-8, Math.min(8, Math.floor($t(n) / 3))) - $t(Math.abs(t)),
    );
  }
  function Zt(t, n) {
    return (
      (t = Math.abs(t)), (n = Math.abs(n) - t), Math.max(0, $t(n) - $t(t)) + 1
    );
  }
  function Qt(t, n, e, i) {
    var r,
      o = C(t, n, e);
    switch ((i = zt(null == i ? ",f" : i)).type) {
      case "s":
        var a = Math.max(Math.abs(t), Math.abs(n));
        return (
          null != i.precision || isNaN((r = Xt(o, a))) || (i.precision = r),
          va(i, a)
        );
      case "":
      case "e":
      ...
      case "r":
        null != i.precision ||
          isNaN((r = Zt(o, Math.max(Math.abs(t), Math.abs(n))))) ||
  ...
  function Jt(t) {
    ...
    return (
      ...
      (t.tickFormat = function (t, e) {
        var i = n();
        return Qt(i[0], i[i.length - 1], null == t ? 10 : t, e);
      }),
      (t.nice = function (e) {
        null == e && (e = 10);
        var i,
    ...
    return (
      ...
      e &&
        ((r.count = function (n, i) {
          return (
            Sa.setTime(+n), Ma.setTime(+i), t(Sa), t(Ma), Math.floor(e(Sa, Ma))
          );
        }),
        (r.every = function (t) {
          return (
  ...
  function en(t) {
    return nn(
      ...
      function (t, n) {
        return (
          (n - t - (n.getTimezoneOffset() - t.getTimezoneOffset()) * Aa) / Na
        );
      },
    );
  }
  ...
  function ln(t) {
    ...
    function e(t, n) {
      return function (e) {
        var r,
          o,
          a = sn(1900, void 0, 1);
        if (i(a, t, (e += ""), 0) != e.length) return null;
        ...
        if (
          ...
          "w" in a || (a.w = 1),
            "Z" in a
              ? ((o = (r = an(sn(a.y, 0, 1))).getUTCDay()),
                (r = o > 4 || 0 === o ? $a.ceil(r) : $a(r)),
                (r = Ra.offset(r, 7 * (a.V - 1))),
                (a.y = r.getUTCFullYear()),
                (a.m = r.getUTCMonth()),
                (a.d = r.getUTCDate() + ((a.w + 6) % 7)))
              : ((o = (r = on(sn(a.y, 0, 1))).getDay()),
                (r = o > 4 || 0 === o ? Oa.ceil(r) : Oa(r)),
          ...
          ("W" in a || "U" in a) &&
            ...
            (o =
              "Z" in a
                ? an(sn(a.y, 0, 1)).getUTCDay()
                : on(sn(a.y, 0, 1)).getDay()),
            (a.m = 0),
            (a.d =
              "W" in a
                ? ((a.w + 6) % 7) + 7 * a.W - ((o + 5) % 7)
                : a.w + 7 * a.U - ((o + 6) % 7)));
        return "Z" in a
          ? ((a.H += (a.Z / 100) | 0), (a.M += a.Z % 100), an(a))
          : on(a);
      };
    }
    function i(t, n, e, i) {
      for (var r, o, a = 0, s = n.length, l = e.length; a < s; ) {
        if (i >= l) return -1;
        if (37 === (r = n.charCodeAt(a++))) {
          if (
            ((r = n.charAt(a++)),
            !(o = B[r in Ba ? n.charAt(a++) : r]) || (i = o(t, e, i)) < 0)
          )
            return -1;
    ...
    function r(t, n, e) {
      ...
      return i ? ((t.p = O[i[0].toLowerCase()]), e + i[0].length) : -1;
    }
    function o(t, n, e) {
      var i = R.exec(n.slice(e));
      return i ? ((t.w = U[i[0].toLowerCase()]), e + i[0].length) : -1;
    }
    function a(t, n, e) {
      var i = I.exec(n.slice(e));
      return i ? ((t.w = F[i[0].toLowerCase()]), e + i[0].length) : -1;
    }
    function s(t, n, e) {
      var i = P.exec(n.slice(e));
      return i ? ((t.m = z[i[0].toLowerCase()]), e + i[0].length) : -1;
    }
    function l(t, n, e) {
      var i = $.exec(n.slice(e));
      return i ? ((t.m = H[i[0].toLowerCase()]), e + i[0].length) : -1;
    }
    function u(t, n, e) {
      return i(t, M, n, e);
    }
  ...
  function Cn(t, n, e) {
    var i = Ya.exec(n.slice(e, e + 6));
    return i ? ((t.L = Math.floor(i[0] / 1e3)), e + i[0].length) : -1;
  }
  function Nn(t, n, e) {
    var i = Ga.exec(n.slice(e, e + 1));
    return i ? e + i[0].length : -1;
  }
  function Ln(t, n, e) {
    var i = Ya.exec(n.slice(e));
  ...
  function On(t, n) {
    return un(t.getDate(), n, 2);
  }
  function In(t, n) {
    return un(t.getHours(), n, 2);
  }
  function Fn(t, n) {
    return un(t.getHours() % 12 || 12, n, 2);
  }
  function Rn(t, n) {
    return un(1 + La.count(Fa(t), t), n, 3);
  }
  function Un(t, n) {
    return un(t.getMilliseconds(), n, 3);
  }
  function $n(t, n) {
    return Un(t, n) + "000";
  }
  function Hn(t, n) {
    return un(t.getMonth() + 1, n, 2);
  }
  function Pn(t, n) {
    return un(t.getMinutes(), n, 2);
  }
  function zn(t, n) {
    return un(t.getSeconds(), n, 2);
  }
  function qn(t) {
    var n = t.getDay();
    return 0 === n ? 7 : n;
  ...
  function jn(t, n) {
    return un(Da.count(Fa(t) - 1, t), n, 2);
  }
  function Bn(t, n) {
    var e = t.getDay();
    return (
      (t = e >= 4 || 0 === e ? Ia(t) : Ia.ceil(t)),
      un(Ia.count(Fa(t), t) + (4 === Fa(t).getDay()), n, 2)
    );
  }
  function Yn(t) {
    return t.getDay();
  ...
  function Gn(t, n) {
    return un(Oa.count(Fa(t) - 1, t), n, 2);
  }
  function Vn(t, n) {
    return un(t.getFullYear() % 100, n, 2);
  }
  function Wn(t, n) {
    return un(t.getFullYear() % 1e4, n, 4);
  }
  function Kn(t) {
  ...
  function Xn(t, n) {
    return un(t.getUTCDate(), n, 2);
  }
  function Zn(t, n) {
    return un(t.getUTCHours(), n, 2);
  }
  function Qn(t, n) {
    return un(t.getUTCHours() % 12 || 12, n, 2);
  }
  function Jn(t, n) {
    return un(1 + Ra.count(Pa(t), t), n, 3);
  }
  function te(t, n) {
    return un(t.getUTCMilliseconds(), n, 3);
  }
  function ne(t, n) {
    return te(t, n) + "000";
  }
  function ee(t, n) {
    return un(t.getUTCMonth() + 1, n, 2);
  }
  function ie(t, n) {
    return un(t.getUTCMinutes(), n, 2);
  }
  function re(t, n) {
    return un(t.getUTCSeconds(), n, 2);
  }
  function oe(t) {
    var n = t.getUTCDay();
    return 0 === n ? 7 : n;
  ...
  function ae(t, n) {
    return un(Ua.count(Pa(t) - 1, t), n, 2);
  }
  function se(t, n) {
    var e = t.getUTCDay();
    return (
      (t = e >= 4 || 0 === e ? Ha(t) : Ha.ceil(t)),
      un(Ha.count(Pa(t), t) + (4 === Pa(t).getUTCDay()), n, 2)
    );
  }
  function le(t) {
    return t.getUTCDay();
  ...
  function ue(t, n) {
    return un($a.count(Pa(t) - 1, t), n, 2);
  }
  function ce(t, n) {
    return un(t.getUTCFullYear() % 100, n, 2);
  }
  function de(t, n) {
    return un(t.getUTCFullYear() % 1e4, n, 4);
  }
  function he() {
    return "+0000";
  }
  ...
  function Se(t, n, e) {
    for (var i = 0, r = t.length; i < r; ++i)
      if (t[i].name === n) {
        (t[i] = Ka), (t = t.slice(0, i).concat(t.slice(i + 1)));
        break;
      }
  ...
  function Me(t) {
    ...
    return (
      ...
      Za.hasOwnProperty(n) ? { space: Za[n], local: t } : t
    );
  }
  function Te(t) {
    return function () {
      var n = this.ownerDocument,
        e = this.namespaceURI;
      return e === Xa && n.documentElement.namespaceURI === Xa
        ? n.createElement(t)
  ...
  function Ne(t) {
    ...
    for (
      ...
      for (
        var o, a, s = n[r], l = s.length, u = (i[r] = new Array(l)), c = 0;
        c < l;
        ++c
      )
        (o = s[c]) &&
  ...
  function Oe(t) {
    ...
    for (var n = this._groups, e = n.length, i = [], r = [], o = 0; o < e; ++o)
      for (var a, s = n[o], l = s.length, u = 0; u < l; ++u)
  ...
  function Fe(t) {
    "function" != typeof t && (t = Ie(t));
    for (
      var n = this._groups, e = n.length, i = new Array(e), r = 0;
      r < e;
      ++r
    )
      for (var o, a = n[r], s = a.length, l = (i[r] = []), u = 0; u < s; ++u)
  ...
  function Pe(t, n, e, i, r, o) {
    for (var a, s = 0, l = n.length, u = o.length; s < u; ++s)
      (a = n[s]) ? ((a.__data__ = o[s]), (i[s] = a)) : (e[s] = new $e(t, o[s]));
    for (; s < l; ++s) (a = n[s]) && (r[s] = a);
  }
  function ze(t, n, e, i, r, o, a) {
    ...
    for (s = 0; s < d; ++s)
      (l = n[s]) &&
        ((p[s] = u = Qa + a.call(l, l.__data__, s, n)),
        u in c ? (r[s] = l) : (c[u] = l));
    for (s = 0; s < h; ++s)
      (l = c[(u = Qa + a.call(t, o[s], s, o))])
        ? ((i[s] = l), (l.__data__ = o[s]), (c[u] = null))
        : (e[s] = new $e(t, o[s]));
    for (s = 0; s < d; ++s) (l = n[s]) && c[p[s]] === l && (r[s] = l);
  }
  function qe(t, n) {
    if (!t)
      return (
    ...
    for (
      ...
      var c = i[u],
        d = r[u],
        h = d.length,
        p = t.call(c, c && c.__data__, u, i),
        f = p.length,
        g = (s[u] = new Array(f)),
        m = (a[u] = new Array(f));
      e(c, d, g, m, (l[u] = new Array(h)), p, n);
  ...
  function ti(t) {
    for (var n = this._groups, e = 0, i = n.length; e < i; ++e)
      for (var r, o = n[e], a = 0, s = o.length; a < s; ++a)
  ...
  function hi(t, n, e) {
    return arguments.length > 1
      ? this.each(
          (null == n ? ui : "function" == typeof n ? di : ci)(
            t,
            n,
            null == e ? "" : e,
          ),
  ...
  function pi(t, n) {
    return (
      ...
      li(t).getComputedStyle(t, null).getPropertyValue(n)
    );
  }
  function fi(t) {
    return function () {
  ...
  function bi(t, n) {
    return arguments.length > 1
      ? this.each((null == n ? fi : "function" == typeof n ? mi : gi)(t, n))
      : this.node()[t];
  }
  function yi(t) {
  ...
  function xi(t, n) {
    for (var e = vi(t), i = -1, r = n.length; ++i < r; ) e.add(n[i]);
  }
  function ki(t, n) {
    for (var e = vi(t), i = -1, r = n.length; ++i < r; ) e.remove(n[i]);
  }
  function Si(t) {
    return function () {
      xi(this, t);
  ...
  function Ti(t, n) {
    return function () {
      (n.apply(this, arguments) ? xi : ki)(this, t);
    };
  }
  function _i(t, n) {
    var e = yi(t + "");
    ...
    return this.each(("function" == typeof n ? Ti : n ? Si : Mi)(e, n));
  }
  function Ai() {
    this.textContent = "";
  }
  ...
  function Ni(t) {
    return arguments.length
      ? this.each(null == t ? Ai : ("function" == typeof t ? Ci : Ei)(t))
  ...
  function Ii(t) {
    return arguments.length
      ? this.each(null == t ? Li : ("function" == typeof t ? Oi : Di)(t))
      : this.node().innerHTML;
  }
  function Fi() {
  ...
  function Hi(t) {
    var n = "function" == typeof t ? t : Ae(t);
  ...
  function zi(t, n) {
    var e = "function" == typeof t ? t : Ae(t),
      i = null == n ? Pi : "function" == typeof n ? n : Ce(n);
    return this.select(function () {
  ...
  function Qi(t, n, e) {
    var i = Ja.hasOwnProperty(t.type) ? Wi : Ki;
    return function (r, o, a) {
      ...
      this.addEventListener(t.type, u, e),
        (s = { type: t.type, name: t.name, value: n, listener: u, capture: e }),
  ...
  function Ji(t, n, e) {
    var i,
      ...
      a = o.length;
    if (!(arguments.length < 2)) {
      for (s = n ? Qi : Zi, null == e && (e = !1), i = 0; i < a; ++i)
        this.each(s(o[i], n, e));
      return this;
    }
  ...
  function ir(t, n) {
    return function () {
      return nr(this, t, n.apply(this, arguments));
    };
  }
  function rr(t, n) {
    return this.each(("function" == typeof n ? ir : er)(t, n));
  }
  function or(t, n) {
    (this._groups = t), (this._parents = n);
  }
  function ar() {
    return new or([[document.documentElement]], ns);
  }
  function sr(t) {
    return "string" == typeof t
      ? new or([[document.querySelector(t)]], [document.documentElement])
      : new or([[t]], ns);
  }
  function lr() {
    for (var t, n = ts; (t = n.sourceEvent); ) n = t;
    return n;
  }
  function ur(t, n) {
  ...
  function cr(t) {
    var n = lr();
    return n.changedTouches && (n = n.changedTouches[0]), ur(t, n);
  }
  function dr(t, n, e) {
    arguments.length < 3 && ((e = n), (n = lr().changedTouches));
    for (var i, r = 0, o = n ? n.length : 0; r < o; ++r)
      if ((i = n[r]).identifier === e) return ur(t, i);
    return null;
  }
  function hr() {
    ts.stopImmediatePropagation();
  }
  function pr() {
    ts.preventDefault(), ts.stopImmediatePropagation();
  }
  function fr(t) {
    var n = t.document.documentElement,
      e = sr(t).on("dragstart.drag", pr, !0);
    "onselectstart" in n
  ...
  function br(t, n, e, i, r, o, a, s, l, u) {
    (this.target = t),
      (this.type = n),
      (this.subject = e),
      (this.identifier = i),
  ...
  function yr() {
    return !ts.ctrlKey && !ts.button;
  }
  function vr() {
    return this.parentNode;
  }
  function wr(t) {
    return null == t ? { x: ts.x, y: ts.y } : t;
  }
  function xr() {
  ...
  function kr() {
    ...
    function n() {
      if (!d && h.apply(this, arguments)) {
        var t = s("mouse", p.apply(this, arguments), cr, this, arguments);
        t &&
          (sr(ts.view).on("mousemove.drag", e, !0).on("mouseup.drag", i, !0),
          fr(ts.view),
          hr(),
          (c = !1),
          (l = ts.clientX),
    ...
    function i() {
      sr(ts.view).on("mousemove.drag mouseup.drag", null),
        gr(ts.view, c),
        pr(),
        m.mouse("end");
    }
    function r() {
      if (h.apply(this, arguments)) {
        var t,
          ...
          r = e.length;
        for (t = 0; t < r; ++t)
          (n = s(e[t].identifier, i, dr, this, arguments)) &&
            (hr(), n("start"));
      }
    }
    function o() {
      var t,
        ...
        e = ts.changedTouches,
        i = e.length;
      for (t = 0; t < i; ++t) (n = m[e[t].identifier]) && (pr(), n("drag"));
    }
    function a() {
      var t,
        n,
      ...
      for (
        ...
        (n = m[e[t].identifier]) && (hr(), n("end"));
    }
    function s(n, e, i, r, o) {
      var a,
        s,
        l,
        u = i(e, n),
        c = b.copy();
      if (
        tr(new br(t, "beforestart", a, n, y, u[0], u[1], 0, 0, c), function () {
          return (
            null != (ts.subject = a = f.apply(r, o)) &&
    ...
    return (
      (t.filter = function (n) {
        return arguments.length
          ? ((h = "function" == typeof n ? n : mr(!!n)), t)
          : h;
      }),
      (t.container = function (n) {
        return arguments.length
          ? ((p = "function" == typeof n ? n : mr(n)), t)
          : p;
      }),
      (t.subject = function (n) {
        return arguments.length
          ? ((f = "function" == typeof n ? n : mr(n)), t)
          : f;
      }),
      (t.touchable = function (n) {
        return arguments.length
          ? ((g = "function" == typeof n ? n : mr(!!n)), t)
          : g;
      }),
      (t.on = function () {
      ...
      (t.clickDistance = function (n) {
        return arguments.length ? ((v = (n = +n) * n), t) : Math.sqrt(v);
      }),
      t
    );
  }
  ...
  function Sr(t) {
    ...
    void 0 !== t.githubUrl &&
      ...
      t.githubCompareUpdatesUrl &&
        (n += `<a href="${t.githubCompareUpdatesUrl}">View all changes</a> to this article since it was first published.`),
      (n += `\n    If you see mistakes or want to suggest changes, please <a href="${
        t.githubUrl + "/issues/new"
    ...
    return (
      ...
      void 0 !== t.publishedDate &&
        (n += `\n    <h3 id="citation">Citation</h3>\n    <p>For attribution in academic contexts, please cite this work as</p>\n    <pre class="citation short">${
          t.concatenatedAuthors
        }, "${t.title}", Distill, ${
          t.publishedYear
        }.</pre>\n    <p>BibTeX citation</p>\n    <pre class="citation long">${v(
          t,
        )}</pre>\n    `),
      n
    );
  ...
  const Mr = [
    ...
    _r = (t) => (t < 10 ? "0" + t : t),
    Ar = function (t) {
      return `${Mr[t.getDay()].substring(0, 3)}, ${_r(t.getDate())} ${Tr[
        t.getMonth()
      ].substring(0, 3)} ${t.getFullYear().toString()} ${t
        .getUTCHours()
        .toString()}:${t.getUTCMinutes().toString()}:${t
        .getUTCSeconds()
        .toString()} Z`;
    },
    Er = function (t) {
      return Array.from(t).reduce(
        (t, [n, e]) => Object.assign(t, { [n]: e }),
        {},
      );
    },
    Cr = function (t) {
      const n = new Map();
      for (var e in t) t.hasOwnProperty(e) && n.set(e, t[e]);
      return n;
    };
  class Nr {
    constructor(t) {
      (this.name = t.author),
        (this.personalURL = t.authorURL),
        (this.affiliation = t.affiliation),
        (this.affiliationURL = t.affiliationURL),
  ...
  class Lr {
    ...
    get publishedDateRFC() {
      return Ar(this.publishedDate);
    }
    get updatedDateRFC() {
      return Ar(this.updatedDate);
    }
    get publishedYear() {
    ...
    get volume() {
      const t = this.publishedYear - 2015;
      if (t < 1)
        throw new Error(
    ...
    get slug() {
      ...
      return (
        this.authors.length &&
          ((t += this.authors[0].lastName.toLowerCase()),
          (t += this.publishedYear),
          (t += this.title.split(" ")[0].toLowerCase())),
        t || "Untitled"
      );
    }
    get bibliographyEntries() {
      return new Map(this.citations.map((t) => [t, this.bibliography.get(t)]));
    }
    set bibliography(t) {
      t instanceof Map
        ? (this._bibliography = t)
        : "object" == typeof t && (this._bibliography = Cr(t));
    }
    get bibliography() {
    ...
    assignToObject(t) {
      Object.assign(t, this),
        (t.bibliography = Er(this.bibliographyEntries)),
        (t.url = this.url),
        (t.doi = this.doi),
        (t.githubUrl = this.githubUrl),
        (t.previewURL = this.previewURL),
        this.publishedDate &&
          ((t.volume = this.volume),
          (t.issue = this.issue),
          (t.publishedDateRFC = this.publishedDateRFC),
          (t.publishedYear = this.publishedYear),
          (t.publishedMonth = this.publishedMonth),
          (t.publishedDay = this.publishedDay),
          (t.publishedMonthPadded = this.publishedMonthPadded),
          (t.publishedDayPadded = this.publishedDayPadded)),
        this.updatedDate && (t.updatedDateRFC = this.updatedDateRFC),
        (t.concatenatedAuthors = this.concatenatedAuthors),
        (t.bibtexAuthors = this.bibtexAuthors),
        (t.slug = this.slug);
    }
  }
  // Copyright 2018 The Distill Template Authors
  const Dr = (t) =>
        ...
        constructor() {
          ...
          const t = { childList: !0, characterData: !0, subtree: !0 },
            n = new MutationObserver(() => {
              n.disconnect(), this.renderIfPossible(), n.observe(this, t);
            });
          n.observe(this, t);
        }
        connectedCallback() {
    ...
    Or =
      ...
      (i) => {
        ...
        return (
          (r.innerHTML = n),
          e && "ShadyCSS" in window && ShadyCSS.prepareTemplate(r, t),
          class extends i {
            static get is() {
              return t;
            }
  ...
  const Fr = function (t, n, e) {
      ...
      for (; i < n.length; ) {
        const e = n[i];
        if (r <= 0 && n.slice(i, i + o) === t) return i;
        "\\" === e ? i++ : "{" === e ? r++ : "}" === e && r--, i++;
      }
      return -1;
    },
        ...
        if ("text" === t[o].type) {
          ...
          for (
            s = a.indexOf(n),
              -1 !== s &&
                ((u = s),
                r.push({ type: "text", data: a.slice(0, u) }),
                (l = !1));
            ;

          ) {
            if (l) {
              if (((s = a.indexOf(n, u)), -1 === s)) break;
              r.push({ type: "text", data: a.slice(u, s) }), (u = s);
            } else {
              if (((s = Fr(e, a, u + n.length)), -1 === s)) break;
              r.push({
                type: "math",
                data: a.slice(u + n.length, s),
    ...
    $r = function (t, n) {
      const e = Ur(t, n.delimiters),
        i = document.createDocumentFragment();
      for (let t = 0; t < e.length; t++)
        if ("text" === e[t].type)
          i.appendChild(document.createTextNode(e[t].data));
        else {
          const r = document.createElement("d-math"),
            o = e[t].data;
          n.displayMode = e[t].display;
          try {
            (r.textContent = o), n.displayMode && r.setAttribute("block", "");
          } catch (r) {
            if (!(r instanceof katex.ParseError)) throw r;
            n.errorCallback(
              "KaTeX auto-render: Failed to parse `" + e[t].data + "` with ",
              r,
            ),
              i.appendChild(document.createTextNode(e[t].rawData));
            continue;
          }
          i.appendChild(r);
        }
    ...
    Hr = function (t, n) {
      for (let e = 0; e < t.childNodes.length; e++) {
        ...
        if (3 === i.nodeType) {
          ...
          if (n.mightHaveMath(r)) {
            const o = $r(r, n);
            (e += o.childNodes.length - 1), t.replaceChild(o, i);
          }
        } else if (1 === i.nodeType) {
          -1 === n.ignoredTags.indexOf(i.nodeName.toLowerCase()) && Hr(i, n);
        }
      }
    },
    Pr = {
    ...
    zr = function (t, n) {
      ...
      const e = Object.assign({}, Pr, n),
        i = e.delimiters.flatMap((t) => [t.left, t.right]),
        r = (t) => i.some((n) => -1 !== t.indexOf(n));
      (e.mightHaveMath = r), Hr(t, e);
    },
  ...
  class Yr extends Dr(Br(HTMLElement)) {
    ...
    static katexLoadedCallback() {
      const t = document.querySelectorAll("d-math");
      for (const n of t) n.renderContent();
    ...
    static addKatex() {
      ...
      (t.src = qr),
        (t.async = !0),
        (t.onload = Yr.katexLoadedCallback),
        (t.crossorigin = "anonymous"),
        document.head.appendChild(t),
        (Yr.katexAdded = !0);
    }
    get options() {
      const t = { displayMode: this.hasAttribute("block") };
      return Object.assign(t, Yr.katexOptions);
    }
    connectedCallback() {
    ...
    renderContent() {
      if ("undefined" != typeof katex) {
        const t = this.root.querySelector("#katex-container");
        katex.render(this.textContent, t, this.options);
      }
    }
  }
  ...
  class Gr extends HTMLElement {
    ...
    constructor() {
      ...
      new MutationObserver((t) => {
        for (const n of t)
          if ("SCRIPT" === n.target.nodeName || "characterData" === n.type) {
            const t = d(this);
            this.notify(t);
          }
      }).observe(this, t);
    ...
    notify(t) {
      const n = new CustomEvent("onFrontMatterChanged", {
        detail: t,
        bubbles: !0,
      });
  ...
  const Vr = new Lr(),
    Wr = {
      ...
      listeners: {
        onCiteKeyCreated(t) {
          const [n, e] = t.detail;
          if (!Vr.citationsCollected)
            return void Wr.waitingOn.citations.push(() =>
              Wr.listeners.onCiteKeyCreated(t),
            );
          if (!Vr.bibliographyParsed)
            return void Wr.waitingOn.bibliography.push(() =>
              Wr.listeners.onCiteKeyCreated(t),
            );
          const i = e.map((t) => Vr.citations.indexOf(t));
          n.numbers = i;
          const r = e.map((t) => Vr.bibliography.get(t));
          n.entries = r;
        },
        onCiteKeyChanged() {
          (Vr.citations = n()), (Vr.citationsCollected = !0);
          for (const t of Wr.waitingOn.citations.slice()) t();
          const t = document.querySelector("d-citation-list"),
            e = new Map(Vr.citations.map((t) => [t, Vr.bibliography.get(t)]));
          t.citations = e;
          const i = document.querySelectorAll("d-cite");
          for (const t of i) {
            const n = t.keys,
              e = n.map((t) => Vr.citations.indexOf(t));
            t.numbers = e;
            const i = n.map((t) => Vr.bibliography.get(t));
            t.entries = i;
          }
        },
        onCiteKeyRemoved(t) {
          Wr.listeners.onCiteKeyChanged(t);
        },
        onBibliographyChanged(t) {
          const n = document.querySelector("d-citation-list"),
            e = t.detail;
          (Vr.bibliography = e), (Vr.bibliographyParsed = !0);
          for (const t of Wr.waitingOn.bibliography.slice()) t();
          if (Vr.citationsCollected)
            if (n.hasAttribute("distill-prerendered"));
            else {
              const t = new Map(
                Vr.citations.map((t) => [t, Vr.bibliography.get(t)]),
              );
              n.citations = t;
            }
          else
            Wr.waitingOn.citations.push(function () {
              Wr.listeners.onBibliographyChanged({
                target: t.target,
                detail: t.detail,
              });
            });
        ...
        onFootnoteChanged() {
          const t = document.querySelector("d-footnote-list");
          if (t) {
        ...
        onFrontMatterChanged(n) {
          ...
          i &&
            (void 0 !== Vr.password
              ? (i.password = Vr.password)
              : i.parentElement.removeChild(i));
          if (!document.body.hasAttribute("distill-prerendered") && u()) {
            h(document, Vr);
            const t = document.querySelector("distill-appendix");
            t && (t.frontMatter = Vr);
            const n = document.querySelector("d-byline");
            n && (n.frontMatter = Vr), e.katex && (Yr.katexOptions = e.katex);
          }
        },
        DOMContentLoaded() {
          if (Wr.loaded) return;
          if (!u()) return;
          Wr.loaded = !0;
          const t = document.querySelector("d-front-matter");
          if (t) {
            const n = d(t);
            Wr.listeners.onFrontMatterChanged({ detail: n });
          }
          (Vr.citations = n()), (Vr.citationsCollected = !0);
          for (const t of Wr.waitingOn.citations.slice()) t();
          if (Vr.bibliographyParsed)
  ...
  class Zr {
    static browserSupportsAllFeatures() {
      return Xr.every((t) => t.support());
    }
    static load(t) {
      const n = function (n) {
        (n.loaded = !0),
          Zr.neededPolyfills.every((t) => t.loaded) &&
            ((window.distillRunlevel = 1), t());
      };
      for (const t of Zr.neededPolyfills) f(t, n);
    }
    static get neededPolyfills() {
      return (
        Zr._neededPolyfills ||
          (Zr._neededPolyfills = Xr.filter((t) => !t.support())),
        Zr._neededPolyfills
      );
    }
  }
  ...
  class no extends to(HTMLElement) {}
  // Copyright 2018 The Distill Template Authors
  const eo = /^\s*$/;
  ...
  var ro =
    ...
    oo = m(function (t, n) {
      !(function (t) {
          ...
          (this.months = [
            ...
            (this.match = function (t, n) {
              if (
                ...
                this.input.substring(this.pos, this.pos + t.length) != t)
              )
                throw (
              ...
              (this.pos += t.length), this.skipWhitespace(n);
            }),
            (this.tryMatch = function (t, n) {
              return (
                (null != n && null != n) || (n = !0),
                this.skipWhitespace(n),
                this.input.substring(this.pos, this.pos + t.length) == t
            ...
            (this.skipWhitespace = function (t) {
              for (; this.isWhitespace(this.input[this.pos]); ) this.pos++;
              if ("%" == this.input[this.pos] && 1 == t) {
            ...
            (this.value_braces = function () {
              var t = 0;
              this.match("{", !1);
              for (var n = this.pos, e = !1; ; ) {
                if (!e)
                  if ("}" == this.input[this.pos]) {
                    if (!(t > 0)) {
                      var i = this.pos;
                      return this.match("}", !1), this.input.substring(n, i);
                    }
                    t--;
                  } else if ("{" == this.input[this.pos]) t++;
            ...
            (this.value_comment = function () {
              for (var t = "", n = 0; !this.tryMatch("}", !1) || 0 != n; ) {
                if (
            ...
            (this.value_quotes = function () {
              ...
              for (var t = this.pos, n = !1; ; ) {
                if (!n) {
                  if ('"' == this.input[this.pos]) {
                    var e = this.pos;
                    return this.match('"', !1), this.input.substring(t, e);
                  }
                  if (this.pos >= this.input.length - 1)
                    throw "Unterminated value:" + this.input.substring(t);
                }
            ...
            (this.single_value = function () {
              ...
              if (this.months.indexOf(n.toLowerCase()) >= 0)
                return n.toLowerCase();
              throw (
                "Value expected:" + this.input.substring(t) + " for key: " + n
              );
            }),
            (this.value = function () {
              var t = [];
              for (t.push(this.single_value()); this.tryMatch("#"); )
                this.match("#"), t.push(this.single_value());
              return t.join("");
            }),
            (this.key = function () {
              for (var t = this.pos; ; ) {
                ...
                if (this.notKey.indexOf(this.input[this.pos]) >= 0)
                  return this.input.substring(t, this.pos);
                this.pos++;
              }
            }),
            (this.key_equals_value = function () {
              var t = this.key();
              if (this.tryMatch("=")) return this.match("="), [t, this.value()];
              throw (
            ...
            (this.key_value_list = function () {
              var t = this.key_equals_value();
              for (
                this.currentEntry.entryTags = {},
                  this.currentEntry.entryTags[t[0]] = t[1];
                this.tryMatch(",") && (this.match(","), !this.tryMatch("}"));

              )
                (t = this.key_equals_value()),
                  (this.currentEntry.entryTags[t[0]] = t[1]);
            }),
            (this.entry_body = function (t) {
              (this.currentEntry = {}),
                (this.currentEntry.citationKey = this.key()),
                (this.currentEntry.entryType = t.substring(1)),
                this.match(","),
                this.key_value_list(),
        ...
        (t.toJSON = function (t) {
          var e = new n();
          return e.setInput(t), e.bibtex(), e.entries;
        }),
          (t.toBibtex = function (t) {
            var n = "";
            for (var e in t) {
              if (
                ((n += "@" + t[e].entryType),
                (n += "{"),
                t[e].citationKey && (n += t[e].citationKey + ", "),
                t[e].entry && (n += t[e].entry),
                t[e].entryTags)
              ) {
                var i = "";
                for (var r in t[e].entryTags)
                  0 != i.length && (i += ", "),
                    (i += r + "= {" + t[e].entryTags[r] + "}");
                n += i;
              }
  ...
  class ao extends HTMLElement {
    ...
    constructor() {
      ...
      new MutationObserver((t) => {
        for (const n of t)
          ("SCRIPT" !== n.target.nodeName && "characterData" !== n.type) ||
    ...
    parseIfPossible() {
      ...
      if (t)
        if ("text/bibtex" == t.type) {
          ...
          if (this.bibtex !== n) {
            this.bibtex = n;
            const t = y(this.bibtex);
            this.notify(t);
          }
        } else if ("text/json" == t.type) {
          const n = new Map(JSON.parse(t.textContent));
          this.notify(n);
        }
    }
    notify(t) {
      const n = new CustomEvent("onBibliographyChanged", {
        detail: t,
        bubbles: !0,
      });
  ...
  class uo extends lo(HTMLElement) {
    ...
    attributeChangedCallback(t, n, e) {
      const i = n ? "onCiteKeyChanged" : "onCiteKeyCreated",
        r = e.split(",").map((t) => t.trim()),
        o = new CustomEvent(i, { detail: [this, r], bubbles: !0 });
      document.dispatchEvent(o);
    }
    set key(t) {
      this.setAttribute("key", t);
    }
    get key() {
      return this.getAttribute("key") || this.getAttribute("bibtex-key");
    }
    get keys() {
      const t = this.key.split(",");
      return t;
    }
    set numbers(t) {
      (this._numbers = t), this.displayNumbers(t);
    }
    get numbers() {
    ...
    displayNumbers(t) {
      ...
      const n =
        "[" + t.map((t) => (-1 == t ? "?" : t + 1 + "")).join(", ") + "]";
      this.innerSpan.textContent = n;
    }
    set entries(t) {
      (this._entries = t), this.displayEntries(t);
    }
    get entries() {
  ...
  var po = m(function (t) {
    var n = (function (t) {
            ...
            for (var f = 0; f < p.length; ++f) {
              ...
              for (
                ...
                if (!(M instanceof n)) {
                  var T = 1;
                  if (y && k != i.tail.prev) {
                    if (((g.lastIndex = S), !(N = g.exec(t)))) break;
                    var _ = N.index + (b && N[1] ? N[1].length : 0),
                      A = N.index + N[0].length,
                      E = S;
                    for (E += k.value.length; _ >= E; )
                      E += (k = k.next).value.length;
                    if (((S = E -= k.value.length), k.value instanceof n))
                      continue;
                    for (
                      var C = k;
                      C !== i.tail &&
                      (E < A ||
                        ("string" == typeof C.value && !C.prev.value.greedy));
                      C = C.next
                    )
                      T++, (E += C.value.length);
                    T--, (M = t.slice(S, E)), (N.index -= S);
                  } else {
                    g.lastIndex = 0;
                    var N = g.exec(M);
                  }
                  if (N) {
                    ...
                    A = (_ = N.index + v) + (N = N[0].slice(v)).length;
                    var L = M.slice(0, _),
                      D = M.slice(A),
                      O = k.prev;
                    if (
                      ...
                      (k = r(
                        i,
                        O,
                        new n(h, m ? c.tokenize(N, m) : N, w, N, y),
                      )),
                      D && r(i, k, D),
                      T > 1 && e(t, i, a, k.prev, S, !0, h + "," + f),
                      u)
                    )
                      break;
                  } else if (u) break;
      ...
      function r(t, n, e) {
        var i = n.next,
          r = { value: e, prev: n, next: i };
        return (n.next = r), (i.prev = r), t.length++, r;
      }
      function o(t, n, e) {
        for (var i = n.next, r = 0; r < e && i !== t.tail; r++) i = i.next;
        (n.next = i), (i.prev = n), (t.length -= r);
      }
      function a(t) {
      ...
      var l = /\blang(?:uage)?-([\w-]+)\b/i,
        ...
        c = {
          ...
          util: {
            encode: function t(e) {
              return e instanceof n
                ? new n(e.type, t(e.content), e.alias)
                : Array.isArray(e)
                  ? e.map(t)
                  : e
                      .replace(/&/g, "&amp;")
            ...
            objId: function (t) {
              return (
                t.__id || Object.defineProperty(t, "__id", { value: ++u }),
                t.__id
              );
            },
            clone: function t(n, e) {
              ...
              switch (((e = e || {}), o)) {
                case "Object":
                  if (((r = c.util.objId(n)), e[r])) return e[r];
                  for (var a in ((i = {}), (e[r] = i), n))
                    n.hasOwnProperty(a) && (i[a] = t(n[a], e));
                  return i;
                case "Array":
                  return (
                    (r = c.util.objId(n)),
            ...
            getLanguage: function (t) {
              for (; t && !l.test(t.className); ) t = t.parentElement;
              return t
                ? (t.className.match(l) || [, "none"])[1].toLowerCase()
                : "none";
            },
          ...
          languages: {
            extend: function (t, n) {
              var e = c.util.clone(c.languages[t]);
              for (var i in n) e[i] = n[i];
              return e;
            },
            insertBefore: function (t, n, e, i) {
              var r = (i = i || c.languages)[t],
                o = {};
              for (var a in r)
              ...
              return (
                (i[t] = o),
                c.languages.DFS(c.languages, function (n, e) {
                  e === l && n != t && (this[n] = o);
                }),
                o
              );
            },
            DFS: function t(n, e, i, r) {
              r = r || {};
              var o = c.util.objId;
              for (var a in n)
                if (n.hasOwnProperty(a)) {
                  ...
                  "Object" !== l || r[o(s)]
                    ? "Array" !== l ||
                      r[o(s)] ||
                      ((r[o(s)] = !0), t(s, e, a, r))
                    : ((r[o(s)] = !0), t(s, e, null, r));
                }
            },
          },
          plugins: {},
          highlightAll: function (t, n) {
            c.highlightAllUnder(document, t, n);
          },
          highlightAllUnder: function (t, n, e) {
            var i = { callback: e, container: t, selector: "d-code" };
            ...
            for (var r, o = 0; (r = i.elements[o++]); )
              c.highlightElement(r, !0 === n, i.callback);
          },
          highlightElement: function (n, e, i) {
            function r(t) {
              (u.highlightedCode = t),
            ...
            var o = c.util.getLanguage(n),
              a = c.languages[o];
            n.className =
              n.className.replace(l, "").replace(/\s+/g, " ") +
              " language-" +
              o;
            var s = n.parentNode;
            s &&
          ...
          highlight: function (t, e, i) {
            ...
            return (
              ...
              n.stringify(c.util.encode(r.tokens), r.language)
            );
          },
          tokenize: function (t, n) {
            ...
            var l = new i();
            return r(l, l.head, t), e(t, l, n, l.head, 0), a(l);
          },
          hooks: {
            all: {},
            add: function (t, n) {
            ...
            run: function (t, n) {
              var e = c.hooks.all[t];
              if (e && e.length) for (var i, r = 0; (i = e[r++]); ) i(n);
            },
          },
          Token: n,
        };
              ...
              t.addEventListener(
                ...
                function (n) {
                  var e = JSON.parse(n.data),
                    ...
                    r = e.code,
                    o = e.immediateClose;
                  t.postMessage(c.highlight(r, c.languages[i], i)),
                    o && t.close();
                },
                !1,
              ),
    ...
    t.exports && (t.exports = n),
      ...
      Object.defineProperty(n.languages.markup.tag, "addInlined", {
        value: function (t, e) {
          ...
          r["language-" + e] = { pattern: /[\s\S]+/, inside: n.languages[e] };
          var o = {};
          (o[t] = {
            pattern: RegExp(
            ...
            .forEach(function (t) {
              if (!t.hasAttribute("data-src-loaded")) {
                for (
                  ...
                  o = o.parentNode;
                if ((o && (i = (t.className.match(a) || [, ""])[1]), !i)) {
                  var s = (r.match(/\.(\w+)$/) || [, ""])[1];
                  i = e[s] || s;
                }
      ...
      (t.languages.markdown = t.languages.extend("markup", {})),
        ...
        ["url", "bold", "italic", "strike"].forEach(function (n) {
          ["url", "bold", "italic", "strike"].forEach(function (e) {
            n !== e &&
              (t.languages.markdown[n].inside.content.inside[e] =
                t.languages.markdown[e]);
          });
        }),
        t.hooks.add("after-tokenize", function (t) {
          ...
          ("markdown" !== t.language && "md" !== t.language) || n(t.tokens);
        }),
        t.hooks.add("wrap", function (n) {
          if ("code-block" === n.type) {
            for (var e = "", i = 0, r = n.classes.length; i < r; i++) {
              var o = n.classes[i],
                a = /language-(.+)/.exec(o);
              if (a) {
                e = a[1];
            ...
            if (s) {
              ...
              n.content = t.highlight(l, s, e);
            } else if (e && "none" !== e && t.plugins.autoloader) {
              var u =
                "md-" +
                new Date().valueOf() +
                "-" +
              ...
              (n.attributes.id = u),
                t.plugins.autoloader.loadLanguages(e, function () {
                  var n = document.getElementById(u);
                  n &&
                    (n.innerHTML = t.highlight(
                      n.textContent,
                      t.languages[e],
                      e,
                    ));
  ...
  class go extends Dr(fo(HTMLElement)) {
    renderContent() {
      if (
        ...
        return;
      const t = po.languages[this.languageName];
      if (null == t) return;
  ...
  class bo extends mo(HTMLElement) {
    constructor() {
      super();
      const t = { childList: !0, characterData: !0, subtree: !0 };
      new MutationObserver(this.notify).observe(this, t);
    }
    notify() {
      const t = new CustomEvent("onFootnoteChanged", {
        detail: this,
        bubbles: !0,
      });
    ...
    connectedCallback() {
      ...
      const t = bo.currentFootnoteId.toString();
      this.root.host.id = "d-footnote-" + t;
      const n = "dt-fn-hover-box-" + t;
      this.hoverBox.id = n;
      const e = this.root.querySelector("#fn-");
      e.setAttribute("id", "fn-" + t),
        e.setAttribute("data-hover-ref", n),
        (e.textContent = t);
    }
  }
  ...
  class vo extends yo(HTMLElement) {
    ...
    set footnotes(t) {
      if (((this.list.innerHTML = ""), t.length)) {
        this.root.style.display = "";
        for (const n of t) {
          const t = document.createElement("li");
          (t.id = n.id + "-listing"), (t.innerHTML = n.innerHTML);
  ...
  class xo extends wo(HTMLElement) {
    ...
    connectedCallback() {}
    listen(t) {
      this.bindDivEvents(this), this.bindTriggerEvents(t);
    }
    bindDivEvents(t) {
      t.addEventListener("mouseover", () => {
        this.visible || this.showAtNode(t), this.stopTimeout();
      }),
    ...
    bindTriggerEvents(t) {
      t.addEventListener("mouseover", () => {
        ...
        t.addEventListener(
          "touchstart",
          (n) => {
            this.visible ? this.hide() : this.showAtNode(t),
              n.stopPropagation();
          },
          { passive: !0 },
        );
    ...
    show(t) {
      (this.visible = !0),
        ...
        (this.style.top = Math.round(t[1] + 10) + "px");
    }
    showAtNode(t) {
      const n = t.getBoundingClientRect();
      this.show([t.offsetLeft + n.width, t.offsetTop + n.height]);
    }
    hide() {
  ...
  class _o extends HTMLElement {
    ...
    static addToReadyQueue(t) {
      -1 === _o.readyQueue.indexOf(t) &&
        (_o.readyQueue.push(t), _o.runReadyQueue());
    }
    static runReadyQueue() {
      const t = _o.readyQueue
        .sort((t, n) => t._seenOnScreen - n._seenOnScreen)
        .filter((t) => !t._ready)
        .pop();
      t && (t.ready(), requestAnimationFrame(_o.runReadyQueue));
    }
    constructor() {
      super(),
        (this._ready = !1),
    ...
    static get marginObserver() {
      if (!_o._marginObserver) {
        const t = window.innerHeight,
          n = Math.floor(2 * t),
          e = { rootMargin: n + "px 0px " + n + "px 0px", threshold: 0.01 },
    ...
    static didObserveMarginIntersection(t) {
      for (const n of t) {
        const t = n.target;
        n.isIntersecting && !t._ready && _o.addToReadyQueue(t);
      }
    }
    ...
    static didObserveDirectIntersection(t) {
      for (const n of t) {
        const t = n.target;
        n.isIntersecting
          ? ((t._seenOnScreen = new Date()), t._offscreen && t.onscreen())
          : t._onscreen && t.offscreen();
      }
    }
    ...
    onscreen() {
      ...
      const t = new CustomEvent("onscreen");
      this.dispatchEvent(t);
    }
    offscreen() {
      (this._onscreen = !1), (this._offscreen = !0);
      const t = new CustomEvent("offscreen");
      this.dispatchEvent(t);
    }
  }
  ...
  class Co extends Eo(HTMLElement) {
    connectedCallback() {
      if (this.shouldRemoveSelf()) this.parentElement.removeChild(this);
      else {
        this.root.querySelector("#interstitial-password-input").oninput = (t) =>
          this.passwordChanged(t);
      }
    }
    passwordChanged(t) {
      t.target.value === this.password &&
    ...
    shouldRemoveSelf() {
      return (
        !(!window || window.location.hostname !== Ao) ||
        ("undefined" != typeof Storage &&
          "true" === localStorage.getItem(this.localStorageIdentifier()))
      );
    }
    localStorageIdentifier() {
      const t = "interstitial-password-correct";
      return "distill-drafts" + (window ? window.location.pathname : "-") + t;
    }
  }
  var No = M(S).right,
    Lo = Math.sqrt(50),
  ...
  L(O, U, {
    ...
    L(
      ...
      D(O, {
        brighter: function (t) {
          return (
            (t = null == t ? Fo : Math.pow(Fo, t)),
            new q(this.r * t, this.g * t, this.b * t, this.opacity)
          );
        },
        darker: function (t) {
          return (
            (t = null == t ? Io : Math.pow(Io, t)),
            new q(this.r * t, this.g * t, this.b * t, this.opacity)
          );
        },
        rgb: function () {
      ...
      D(O, {
        ...
        rgb: function () {
          var t = (this.h % 360) + 360 * (this.h < 0),
            ...
            r = 2 * e - i;
          return new q(
            X(t >= 240 ? t - 240 : t + 120, r, i),
            X(t, r, i),
            X(t < 120 ? t + 240 : t - 120, r, i),
            this.opacity,
          );
        },
        displayable: function () {
    ...
    D(O, {
      ...
      rgb: function () {
        ...
        return new q(
          ...
          et(-0.9787684 * n + 1.9161415 * t + 0.033454 * e),
          et(0.0719453 * n - 0.2289914 * t + 1.4052427 * e),
          this.opacity,
        );
      },
    }),
  ...
  L(
    ...
    D(O, {
      ...
      rgb: function () {
        var t = isNaN(this.h) ? 0 : (this.h + 120) * Vo,
          n = +this.l,
  ...
  var da,
    ha = (function t(n) {
      function e(t, n) {
        var e = i((t = z(t)).r, (n = z(n)).r),
          r = i(t.g, n.g),
          o = i(t.b, n.b),
          a = gt(t.opacity, n.opacity);
        return function (n) {
          return (
            (t.r = e(n)), (t.g = r(n)), (t.b = o(n)), (t.opacity = a(n)), t + ""
          );
        };
      }
      var i = ft(n);
  ...
  var _a = 1e3,
    ...
    La =
      ...
      nn(
        function (t) {
          t.setTime(t - t.getMilliseconds() - t.getSeconds() * _a);
        },
        function (t, n) {
          t.setTime(+t + n * Aa);
        },
      ...
      nn(
        function (t) {
          t.setTime(
            t - t.getMilliseconds() - t.getSeconds() * _a - t.getMinutes() * Aa,
          );
        },
        function (t, n) {
          t.setTime(+t + n * Ea);
      ...
      nn(
        ...
        function (t, n) {
          return (
            (n - t - (n.getTimezoneOffset() - t.getTimezoneOffset()) * Aa) / Ca
          );
        },
        function (t) {
          return t.getDate() - 1;
  ...
  var Wa = "%Y-%m-%dT%H:%M:%S.%LZ",
    Ka =
      (Date.prototype.toISOString || qa(Wa),
      +new Date("2000-01-01T00:00:00.000Z") || ja(Wa),
      { value: function () {} });
  we.prototype = ve.prototype = {
    ...
    on: function (t, n) {
      ...
      if (!(arguments.length < 2)) {
        ...
        for (; ++o < a; )
          if ((e = (t = r[o]).type)) i[e] = Se(i[e], t.name, n);
          else if (null == n) for (e in i) i[e] = Se(i[e], t.name, null);
        return this;
      }
      for (; ++o < a; )
        if ((e = (t = r[o]).type) && (e = ke(i[e], t.name))) return e;
    },
    copy: function () {
      var t = {},
        n = this._;
  ...
  class rs extends es(HTMLElement) {
    connectedCallback() {
      (this.connected = !0),
        ...
        (this.scale = tn()
          ...
          .range([0, 1])
          .clamp(!0)),
        (this.origin = void 0 !== this.origin ? this.origin : this.min),
    ...
    attributeChangedCallback(t, n, e) {
      isNaN(e) ||
        ...
        "value" == t && this.update(+e),
        "origin" == t && (this.origin = +e),
        "step" == t && e > 0 && (this.step = +e),
        "ticks" == t && (this.ticks = "" === e || e));
    }
    onKeyDown(t) {
      this.changeValue = this.value;
      let n = !1;
      switch (t.keyCode) {
        case is.left:
        case is.down:
          this.update(this.value - this.step), (n = !0);
          break;
        case is.right:
        case is.up:
          this.update(this.value + this.step), (n = !0);
        ...
        case is.pageUp:
        case is.pageDown:
          this.update(this.value + 10 * this.step), (n = !0);
          break;
        case is.home:
          this.update(this.min), (n = !0);
          break;
        case is.end:
          this.update(this.max), (n = !0);
      }
      n &&
    ...
    dragUpdate() {
      const t = this.background.getBoundingClientRect(),
        n = ts.x,
        e = t.width;
      this.update(this.scale.invert(n / e));
    }
    update(t) {
      let n = t;
      "any" !== this.step && (n = this.quantizeValue(t, this.step)),
        (n = this.validateValueRange(this.min, this.max, n)),
        this.connected &&
          ((this.knob.style.left = 100 * this.scale(n) + "%"),
          (this.trackFill.style.width =
            100 * this.scale(this.min + Math.abs(n - this.origin)) + "%"),
          (this.trackFill.style.left =
            100 * this.scale(Math.min(n, this.origin)) + "%")),
        this.value !== n &&
          ((this.value = n),
    ...
    renderTicks() {
      const t = this.root.querySelector(".ticks");
      if (!1 !== this.ticks) {
        let n = [];
        (n =
          this.ticks > 0
            ...
            : "any" === this.step
              ? this.scale.ticks()
              : _(this.min, this.max + 1e-6, this.step)),
          n.forEach((n) => {
            const e = document.createElement("div");
            e.classList.add("tick"),
              (e.style.left = 100 * this.scale(n) + "%"),
              t.appendChild(e);
          });
      } else t.style.display = "none";
    }
  ...
  const fs = function () {
    ...
    for (const [t, n] of Object.entries(Wr.listeners))
      "function" == typeof n && document.addEventListener(t, n);
    window.distill.runlevel += 1;
    const t = [
        Jr,
        no,
    ...
    const e = t.concat(n);
    for (const t of e) customElements.define(t.is, t);
    (window.distill.runlevel += 1),
      u() && Wr.listeners.DOMContentLoaded(),
  ...
  (window.distill = { runlevel: ps, initialize: fs, templateIsLoading: hs }),
    Zr.browserSupportsAllFeatures()
      ? ((window.distill.runlevel += 1), window.distill.initialize())
