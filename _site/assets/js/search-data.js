      ...
      window.location.href = "/alarconvv/";
          ...
          handler: () => {
            window.location.href = "/alarconvv/teaching/";
              ...
              section: "Dropdown",
              handler: () => {
                window.location.href = "/alarconvv/posters/";
              },
        ...
        handler: () => {
          ...
          description: "",
          section: "News",},{id: "posters-project-1",
          title: 'project 1',
          description: "with background image",
          section: "Posters",handler: () => {
              window.location.href = "/alarconvv/posters/1_project/";
            },},{id: "posters-project-2",
          title: 'project 2',
          description: "a project with a background image and giscus comments",
          section: "Posters",handler: () => {
              window.location.href = "/alarconvv/posters/2_project/";
            },},{id: "posters-project-3-with-very-long-name",
          title: 'project 3 with very long name',
          description: "a project that redirects to another website",
          section: "Posters",handler: () => {
              window.location.href = "/alarconvv/posters/3_project/";
