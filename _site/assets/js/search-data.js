...
ninja.data = [
  ...
  },
  {
    ...
    title: "repositories",
    description:
      "Some repos from my work. (I promise organize my academic life soon &#39;:D)",
    section: "Navigation",
    handler: () => {
  ...
  },
  {
    ...
    title: "resume",
    description:
      "For a complete academic history, please download the PDF version of my CV",
    section: "Navigation",
    handler: () => {
  ...
  },
  {
    ...
    handler: () => {
      window.open(
        "mailto:%76%69%76%69%61%6E%61%72%6F%6D%65%72%6F%61%6C%61%72%63%6F%6E@%75%6D%62.%65%64%75",
        "_blank",
      );
    },
  },
